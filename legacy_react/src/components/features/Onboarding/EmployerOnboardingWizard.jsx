...
const EmployerOnboardingWizard = () => {
  ...
  const steps = [
    {
      ...
      validate: (data) => data.companyName && data.companyName.length > 2 && data.industry
    },
    {
      component: StepCompanyDetails,
      validate: (data) => data.companySize && data.companyBio && data.companyBio.length > 10
    },
  ];
    ...
    if (step < steps.length - 1) {
      ...
      try {
        ...
        if (result.success) {
          ...
          // Fallback: update locally and navigate
          updateUserLocal({
            ...formData,
            onboardingComplete: true,
          });
